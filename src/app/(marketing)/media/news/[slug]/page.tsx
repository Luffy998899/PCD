...
export async function generateStaticParams() {
  ...
  return refs
    .filter((ref) => ref.article_type === 'news')
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  if (!article || article.article_type !== 'news') {
...
export default async function Page({ params }: { params: Params }) {
  ...
  if (!article || article.article_type !== 'news') notFound()

  return <ArticleDetail article={article} basePath="/media/news" sectionLabel="News" />
}
