...
export async function generateStaticParams() {
  ...
  return refs
    .filter((ref) => ref.article_type === 'press_release')
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  if (!article || article.article_type !== 'press_release') {
  ...
  return buildMetadata({
    ...
    path: `/media/press-releases/${article.slug}`,
...
export default async function Page({ params }: { params: Params }) {
  ...
  if (!article || article.article_type !== 'press_release') notFound()

  return <ArticleDetail article={article} basePath="/media/press-releases" sectionLabel="Press releases" />
}
